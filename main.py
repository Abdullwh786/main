...
<head>
  ...
  <title>N9SIIR L3G3ND H3R3</title>
...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa"> 𝐍𝐎𝐍--   𝐒𝐓𝐎𝐏 𝗥𝗨𝗡𝗜𝗜𝗡𝗚</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">𝙔𝙊𝙐𝙍 𝘿𝘼𝘿 𝙉𝘼𝙎𝙄𝙄𝙍 𝘼𝙇𝙄𝙄 𝙃𝙀𝙍𝙀</span></span></p>
  </p>
    </footer>
    </div>
</div>
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">𝑴𝑨𝑫𝑬 𝑩𝒀 𝗡𝗔𝗦𝗜𝗜𝗥 𝗔𝗟𝗜𝗜 𝗞𝗜𝗜𝗡𝗚</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span">❰𝗗𝗘𝗩𝗜𝗜𝗟 __ 𝗞𝗜𝗜𝗡𝗚❱</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">SUBSCRIBE ON</span> <a href="https://www.facebook.com/LEGEND.DEVIIL.KIING.ON.FIRE" class="color-s">𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 </a></p>
    </footer>
    </div>
</div>
